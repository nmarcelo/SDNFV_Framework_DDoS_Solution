...
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.FLOW_PRIORITY;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.FLOW_PRIORITY_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.FLOW_TIMEOUT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.FLOW_TIMEOUT_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.IGNORE_IPV4_MCAST_PACKETS;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.IGNORE_IPV4_MCAST_PACKETS_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.IPV6_FORWARDING;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.IPV6_FORWARDING_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_DST_MAC_ONLY;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_DST_MAC_ONLY_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_ICMP_FIELDS;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_ICMP_FIELDS_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_IPV4_ADDRESS;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_IPV4_ADDRESS_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_IPV4_DSCP;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_IPV4_DSCP_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_IPV6_ADDRESS;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_IPV6_ADDRESS_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_IPV6_FLOW_LABEL;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_IPV6_FLOW_LABEL_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_TCP_UDP_PORTS;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_TCP_UDP_PORTS_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_VLAN_ID;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.MATCH_VLAN_ID_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.PACKET_OUT_OFPP_TABLE;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.PACKET_OUT_OFPP_TABLE_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.PACKET_OUT_ONLY;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.PACKET_OUT_ONLY_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.RECORD_METRICS;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.RECORD_METRICS_DEFAULT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.INHERIT_FLOW_TREATMENT;
import static mx.itesm.reactiveFwd.OsgiPropertyConstants.INHERIT_FLOW_TREATMENT_DEFAULT;
...
public class reactiveFwd {
    ...
    public void activate(ComponentContext context) {
        appId = coreService.registerApplication("mx.itesm.reactiveFwd");
