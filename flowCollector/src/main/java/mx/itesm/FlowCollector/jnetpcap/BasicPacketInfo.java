...
/*  Basic Info to generate flows from packets  	*/
    ...
    private    String device_ID; // switch device
...
/* ******************************************** */    
	...
	public BasicPacketInfo(byte[] src, byte[] dst, int srcPort, int dstPort,
		...
		//this.device_ID = device_ID; // not ennabled here
	...
	public String generateFlowId(){
        ...
        if(forward){
            this.flowId = this.device_ID + "-" + this.getSourceIP() + "-" + this.getDestinationIP() + "-" + this.srcPort  + "-" + this.dstPort  + "-" + this.protocol;
        }else{
            this.flowId = this.device_ID + "-" + this.getDestinationIP() + "-" + this.getSourceIP() + "-" + this.dstPort  + "-" + this.srcPort  + "-" + this.protocol;
        }
        return this.flowId;
	}
	...
	public byte[] getDstMac() {
		return Arrays.copyOf(dstmac,dstmac.length);
	}
