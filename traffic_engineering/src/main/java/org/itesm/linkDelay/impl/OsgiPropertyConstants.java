...
public final class OsgiPropertyConstants {
    ...
    static final String PROBE_SPLITER = ";";
    static final short PROBE_ETHERTYPE = 0x3366;

    static final String PROBE_SRC = "20:15:08:10:00:05";
    static final String PROBE_DST = "FF:FF:FF:FF:FF:FF";


    /** Interval for sending probe. */
    static final int  PROBE_INTERVAL_DEFAULT = 1000; // ms

    /** Interval for calculating latency. */
    static final int CALCULATE_INTERVAL_DEFAULT = 1000; // ms

    /** Number of buffered latency records. */
    static final int LATENCY_AVERAGE_SIZE_DEFAULT = 5;

    /** Interval for sending probe. */
    static final String  PROBE_INTERVAL= "probeInterval";

    /** Interval for calculating latency. */
    static final String CALCULATE_INTERVAL= "calculateInterval"; // ms

    /** Number of buffered latency records. */
    static final String LATENCY_AVERAGE_SIZE= "latencyAverageSize";
}